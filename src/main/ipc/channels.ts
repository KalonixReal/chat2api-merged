export const IpcChannels = {
  ...
  PROVIDERS_FETCH_LIVE_MODELS: 'providers:fetchLiveModels',
  PROVIDERS_FETCH_ALL_LIVE_MODELS: 'providers:fetchAllLiveModels',
  PROVIDERS_MERGE_LIVE_MODELS: 'providers:mergeLiveModels',
  ...
  SUPERVISOR_GET_STATUS: 'supervisor:getStatus',
  SUPERVISOR_RESTART: 'supervisor:restart',
  SUPERVISOR_STATUS_CHANGED: 'supervisor:statusChanged',

  // Provider Setup page — collect credentials for the 4 vendored daemons
  // (Qwen / DeepSeek / Z.ai-GLM / Kimi) in one place.
  PROVIDER_SETUP_GET_STATUS: 'providerSetup:getStatus',
  PROVIDER_SETUP_ADD_QWEN_ACCOUNT: 'providerSetup:addQwenAccount',
  PROVIDER_SETUP_REMOVE_QWEN_ACCOUNT: 'providerSetup:removeQwenAccount',
  PROVIDER_SETUP_LIST_QWEN_ACCOUNTS: 'providerSetup:listQwenAccounts',
  PROVIDER_SETUP_LOGIN_DEEPSEEK: 'providerSetup:loginDeepSeek',
  PROVIDER_SETUP_SET_ZAI_TOKEN: 'providerSetup:setZaiToken',
  PROVIDER_SETUP_SET_KIMI_TOKEN: 'providerSetup:setKimiToken',
  PROVIDER_SETUP_TEST_CHAT: 'providerSetup:testChat',

  // Notifications system — surfaces CAPTCHA / throttle / recovery / daemon
  // events to the user. Push channel is NOTIFICATIONS_NEW (main → renderer).
