...
function setupCanvasInput(canvas, ws) {
  ...
  canvas.addEventListener('mouseenter', function (e) {
    ...
    if (ws.readyState === WebSocket.OPEN) {
      ...
      ws.send(
        JSON.stringify({ type: 'input', event: { type: 'mousemove', x: coords.x, y: coords.y, button: e.button, buttons: e.buttons } }),
      );
    }
  });

  canvas.addEventListener('focus', function () {
    canvas.classList.add('input-captured');
  });

  canvas.addEventListener('blur', function () {
    canvas.classList.remove('input-captured');
  });
  ...
  canvas.addEventListener('mousemove', function (e) {
    ...
    ws.send(
      JSON.stringify({
        type: 'input',
        event: { type: 'mousemove', x: coords.x, y: coords.y, button: e.button, buttons: e.buttons },
      }),
    );
  });
  ...
  canvas.addEventListener('mousedown', function (e) {
    ...
    ws.send(
      JSON.stringify({
        type: 'input',
        event: { type: 'mousedown', x: coords.x, y: coords.y, button: e.button, buttons: e.buttons },
      }),
    );
  });
  ...
  canvas.addEventListener('mouseup', function (e) {
    ...
    ws.send(
      JSON.stringify({
        type: 'input',
        event: { type: 'mouseup', x: coords.x, y: coords.y, button: e.button, buttons: e.buttons },
      }),
    );
  });
