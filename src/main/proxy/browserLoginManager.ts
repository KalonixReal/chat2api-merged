...
const CONFIGS: Record<string, ProviderConfig> = {
  qwen: { url: 'https://chat.qwen.ai/', label: 'Qwen', cookieNames: [], localStorageKeys: ['token'], providerId: 'qwen', accountName: 'Qwen Login', emailSelector: 'input[type="text"], input[type="email"], input[placeholder*="邮箱"], input[placeholder*="email"]', passwordSelector: 'input[type="password"]', submitSelector: 'button[type="submit"], button:has-text("登录"), button:has-text("Sign in")' },
